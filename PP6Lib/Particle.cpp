...
Particle::Particle(const double& e_1_, const double& px_1_, const double& py_1_, const double& pz_1_, const double& e_2_, const double& px_2_, const double& py_2_, const double& pz_2_)
